...
// ==========================================
const rurekey = {
    // 核心主力地区 (单字匹配已全部加上汉字边界锁定，彻底杜绝单字劫持)
    ...
    "波斯尼亚和黑塞哥维那": /波黑(?:共和国)?|波斯尼亚和黑塞哥维那|BA|Bosnia|Herzegovina|🇧🇦/i, // 增加了“波黑”
    ...
    "黑山共和国": /黑山(?:共和国)?/i,      // 补充常用简写
    "沙特阿拉伯": /沙特(?:阿拉伯)?/i,      // 补充常用简写
    "哈萨克斯坦": /哈萨克(?:斯坦)?/i       // 补充常用简写
};
