function main(config) {
  ...
  const baseFB = { type: "fallback", interval: 200, lazy: true, url: "https://www.google.com/generate_204", hidden: false };
  ...
  config["proxy-groups"] = [
    ...
    Object.assign({}, baseUT, { name: "🪫♻️自动选择", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseFB, { name: "🪫🛟故障转移", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇭🇰香港节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["香港"].source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇹🇼台湾节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["台湾"].source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇯🇵日本节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["日本"].source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇺🇲美国节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["美国"].source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇸🇬新加坡节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["新加坡"].source})(?!.*${regexLowRate.source}).*$` }),
    Object.assign({}, baseUT, { name: "🪫🇰🇷韩国节点", "include-all": true, filter: `^(?=.*${regexLowQuality.source})(?=.*${regexRegions["韩国"].source})(?!.*${regexLowRate.source}).*$` })
  ];
